...
<body>
    ...
    <hr><hr><hr><hr><hr><hr>
       ...
       <?php
        ...
        <h2 style="margin-right:500px;"> Sorted By Most Recent</h2>
        <div>
            <a href="all_aquestions.php" class="btn btn-outline-primary  " style="margin-right:170px;font-size:17px">Sort By: Answers</a>
            </div></div>

        <?php
        $questions =searchaQuestions("");;
