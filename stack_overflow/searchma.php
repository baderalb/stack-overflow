...
$answers = SearchMAnswer($_GET['search']);
?>
<!DOCTYPE html>
<html lang="en">
...
<body >
    ...
    <div class="containerQustionContent"> <h1>Results:</h1>
        <a href="my_answers.php"  class="btn btn-outline-primary  border border-secondary" style="font-size:25px">Reset</a>
     </div>
        <?php
        if(!isset($answers)){echo'<h2>no such answers</h2>';}
        else{
